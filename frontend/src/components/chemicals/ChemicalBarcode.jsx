...
const ChemicalBarcode = ({ show, onHide, chemical }) => {
  ...
  const handlePrint = async () => {
    ...
    try {
      ...
      printPdfLabel(pdfBlob, `chemical-${chemical.part_number}-${chemical.lot_number}-label.pdf`);
    } catch (err) {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      downloadPdfLabel(pdfBlob, `chemical-${chemical.part_number}-${chemical.lot_number}-label.pdf`);
    } catch (err) {
  ...
  return (
    <Modal show={show} onHide={onHide} centered size="lg">
      <Modal.Header closeButton>
        <Modal.Title>Chemical Barcode Label</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        {error && (
