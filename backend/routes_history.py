...
from models import db, Tool, Chemical, Checkout, ChemicalIssuance, InventoryTransaction, AuditLog, WarehouseTransfer, Warehouse
from models_kits import KitItem, KitExpendable, KitIssuance, KitTransfer, Kit
...
def _build_item_history(item, item_type, identifier, tracking_number):
    ...
    if item_type in ['tool', 'chemical']:
        ...
        history_events.append({
            ...
            'description': f'Expendable added to kit',
            'user': 'System',
            'details': {
                'identifier': identifier,
                'tracking_number': tracking_number
...
def _format_transaction_description(transaction):
    ...
    if trans_type == 'receipt':
        return f'Received into inventory'
    elif trans_type == 'issuance':
    ...
    elif trans_type == 'checkout':
        return f'Checked out'
    elif trans_type == 'return':
        return f'Returned'
    elif trans_type == 'kit_issuance':
        return f'Issued from kit'
    else:
