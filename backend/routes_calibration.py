...
from auth.jwt_manager import jwt_required, tool_manager_required as jwt_tool_manager_required
import logging

logger = logging.getLogger(__name__)

# Use JWT-based tool manager decorator from auth module
# (The jwt_tool_manager_required is imported above)

def register_calibration_routes(app):
    # Get all calibration records
    @app.route('/api/calibrations', methods=['GET'])
    @jwt_tool_manager_required
