...
def get_channels():
    ...
    try:
        ...
        logger.error(f"Error fetching channels: {e!s}", exc_info=True)
...
def get_channel(channel_id):
    ...
    try:
        ...
        logger.error(f"Error fetching channel {channel_id}: {e!s}", exc_info=True)
...
def create_channel():
    ...
    try:
        ...
        db.session.rollback()
        logger.error(f"Error creating channel: {e!s}", exc_info=True)
...
def update_channel(channel_id):
    ...
    try:
        ...
        logger.info("Channel updated", extra={
            "channel_id": channel_id,
        ...
        db.session.rollback()
        logger.error(f"Error updating channel: {e!s}", exc_info=True)
...
def delete_channel(channel_id):
    ...
    try:
        ...
        logger.info("Channel deleted", extra={
            "channel_id": channel_id,
        ...
        db.session.rollback()
        logger.error(f"Error deleting channel: {e!s}", exc_info=True)
...
def get_channel_members(channel_id):
    ...
    try:
        ...
        logger.error(f"Error fetching channel members: {e!s}", exc_info=True)
...
def add_channel_member(channel_id):
    ...
    try:
        ...
        logger.info("Member added to channel", extra={
            "channel_id": channel_id,
            "user_id": user_id,
            "role": role,
        ...
        db.session.rollback()
        logger.error(f"Error adding channel member: {e!s}", exc_info=True)
...
def remove_channel_member(channel_id, user_id):
    ...
    try:
        ...
        logger.info("Member removed from channel", extra={
            "channel_id": channel_id,
            "user_id": user_id,
        ...
        db.session.rollback()
        logger.error(f"Error removing channel member: {e!s}", exc_info=True)
...
def get_channel_messages(channel_id):
    ...
    try:
        ...
        logger.error(f"Error fetching channel messages: {e!s}", exc_info=True)
...
def delete_channel_message(channel_id, message_id):
    ...
    try:
        ...
        logger.info("Channel message deleted", extra={
        ...
        db.session.rollback()
        logger.error(f"Error deleting message: {e!s}", exc_info=True)
