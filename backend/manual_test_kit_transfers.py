...
def main():
    ...
    # Get items in kit 1
    items1_before, _exp1_before = get_kit_items(token, kit1_id)
    items2_before, _exp2_before = get_kit_items(token, kit2_id)
    ...
    items1_after, _exp1_after = get_kit_items(token, kit1_id)
    items2_after, _exp2_after = get_kit_items(token, kit2_id)
